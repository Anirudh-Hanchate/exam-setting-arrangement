...
if __name__ == '__main__':
    ...
    # In a production environment like Render, you'll use a Gunicorn
    # server instead of Flask's built-in server. Gunicorn will listen on
    # 0.0.0.0 and the port specified by the environment.
